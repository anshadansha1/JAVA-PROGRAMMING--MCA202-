//PROGRAM : Server Program [sending messages continuously]

import java.io.*;
import java.net.*;
import java.util.*;

public class P51_netwroking2_server {
...
/*OUTPUT
 E:\MCA\SEM 2\JAVA PROGRAMMING (MCA202)\class notes>java P51_netwroking2_server
